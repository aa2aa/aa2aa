...
date_default_timezone_set("Asia/Baghdad");
  ...
  $MadelineProto = new \danog\MadelineProto\API('OMAR.madeline', $settings);
  $MadelineProto->start();
function bot($method, $datas = []) {
    ...
    $OMARch = file_get_contents("oldchannel");
    $x = 0;
while(1){
